...
/***/ function(module, exports, __webpack_require__) {
	...
	var coreOptions = __webpack_require__(1);
	var coreViewport = __webpack_require__(2);
	var coreCellManager = __webpack_require__(8);
	var coreScrollManager = __webpack_require__(26);
	var coreMouseManager = __webpack_require__(28);
	var coreCell = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function percentile(data, p) {
	  ...
	  var v = _.sortBy(data, function (n) {
	    return n;
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basicCellManager = __webpack_require__(9);
	var queryResultViewerCellManager = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @return {basicCellManager}
	 */
	basicCellManager.prototype.removeCellsAtIndexRange = function (start, end, duration) {
	  this.lastChange = new Date().getTime();
	...
	basicCellManager.prototype.findApproximateViewportCells = function () {
	  ...
	  var aproximateCellsInViewport = this.tableCloth.options.height / averageCellHeight + 40;

	  viewportCells = this.cells.slice(Math.floor(aproximateCellsAboveViewport), Math.ceil(aproximateCellsAboveViewport + aproximateCellsInViewport));
	...
	basicCellManager.prototype.findCellAtPosition = function (x, y) {
	  ...
	  for (var i = 0; i < cellsToCheck.length; i++) {
	    ...
	    if (cell.options.x < x && cell.options.x + cell.options.width > x) {
	      if (cell.options.y - scrollPos < y && cell.options.y + cell.options.height - scrollPos > y) {
	        foundCell = cell;
	        break;
	      }
	    }
	...
	basicCellManager.prototype.renderCellsAtPosition = function (x, y) {
	  ...
	  cellsToRender.some(function (cell) {
	    ...
	    if (cell.options.y + cell.options.height > self.scrollPosition) {
	      ...
	      cell.render(self.tableCloth, 0, self.scrollPosition - self.headerHeight, highlight);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	queryResultViewerCellManager.prototype.collapseAll = function (duration) {
	  ...
	  var newCells = this.cells.map(function (cell) {
	    if (cell.options.state === 'open') {
	      indices = indices.concat(cell.options.subCells.map(function (cell) {
	        return cell.options.index;
	      }));
	 ...
	 * @return {queryResultViewerCellManager}
	 */
	queryResultViewerCellManager.prototype.animateToScale = function (domain, range, duration, easeName) {
	  var self = this;
	  var start = new Date().getTime();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basicCell = __webpack_require__(13);
	var queryResultViewerBodyCell = __webpack_require__(19);
	var queryResultViewerSummaryCell = __webpack_require__(22);
	var queryResultViewerHeaderCell = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * cells                                                                   *
	 ***************************************************************************/
	var cellOptions = __webpack_require__(14);
	var util = __webpack_require__(3);
	var ease = __webpack_require__(7);
	...
	basicCell.prototype.render = function (tableCloth, xOffset, yOffset, highlight) {
	  ...
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, width, height, this.options.bgColor);

	  // draw the label
	  render.text(tableCloth.viewport.ctx, this.options.label, this.options.x + xOffset + 40, this.options.y - yOffset + 19);
	...
	basicCell.prototype.renderHighlight = function (tableCloth, xOffset, yOffset, highlight) {
	  ...
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, 5, height, 'black');
	...
	basicCell.prototype.animateToHeight = function (tableCloth, height, duration, easeName) {
	  var self = this;
	  var start = new Date().getTime();
	...
	basicCell.prototype.animateToOpacity = function (tableCloth, opacity, duration, easeName) {
	  var self = this;
	  var start = new Date().getTime();
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 ***********************/
	var render = {};
	render.background = __webpack_require__(6);
	render.rect = __webpack_require__(16);
	render.text = __webpack_require__(17);
	render.dashedLine = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 ************************************************************************/
	var basicCell = __webpack_require__(13);
	var cellOptions = __webpack_require__(20);
	var util = __webpack_require__(3);
	var render = __webpack_require__(15);
	var ease = __webpack_require__(7);
	...
	queryResultViewerBodyCell.prototype.render = function (tableCloth, xOffset, yOffset, highlight) {
	  ...
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, this.options.width, this.options.height, '#EEEEEE');
	  ...
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset + 33, this.options.y - yOffset, 5, this.options.height, this.options.cellColor);

	  // render the score text for the row
	  render.text(tableCloth.viewport.ctx, this.options.score.toFixed(2), this.options.width - 60, this.options.y - yOffset + 19, '#BDBDBD');

	  // render the score indicator for the row
	  render.rect(tableCloth.viewport.ctx, this.scale(this.options.score) + xOffset, this.options.y - yOffset, 2, this.options.height, this.options.cellColor);

	  // render an overlay to emphasize the |90 - 100| scores
	  render.rect(tableCloth.viewport.ctx, this.scale(-90) + xOffset, this.options.y - yOffset, this.scale(90) - this.scale(-90), this.options.height, '#EEEEEE', 0.8);
	  ...
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, this.options.width, 1, 'white');

	  return this;
	};

	queryResultViewerBodyCell.prototype.renderHighlight = function (tableCloth, xOffset, yOffset, highlight) {
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, 33, this.options.height, '#183b8e');
	...
	queryResultViewerBodyCell.prototype.renderTailBoundaries = function (tableCloth, xOffset, yOffset) {
	  ...
	  bounds.forEach(function (bound) {
	    render.dashedLine(tableCloth.viewport.ctx, [self.scale(bound) + xOffset, self.scale(bound) + xOffset], [self.options.y - yOffset, self.options.y - yOffset + 24]);
	  });
	};
	...
	queryResultViewerBodyCell.prototype.setScale = function (domain, range) {
	  ...
	  if (domain && range) {
	    ...
	    this.scale = d3.scale.linear().domain([-100, -90, 90, 100]).range([start, unit * 10 + 200, unit * 190 + 200, end]);
	  }
	 ...
	 * @return {queryResultViewerBodyCell}
	 */
	queryResultViewerBodyCell.prototype.animateToScale = function (tableCloth, domain, range, easeName) {
	  var self = this;
	  var start = new Date().getTime();
	  var tmpDomain, tmpRange;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = __webpack_require__(15);
	var util = __webpack_require__(3);
	var cellOptions = __webpack_require__(23);
	...
	queryResultViewerSummaryCell.prototype.render = function (tableCloth, xOffset, yOffset, highlight) {
	  // render the background of the cell
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, this.options.width, this.options.height, '#DDDDDD');

	  // render the label
	  render.text(tableCloth.viewport.ctx, this.options.label, this.options.x + xOffset + 40, this.options.y - yOffset + 19);

	  // render an overlay to block labels in the summary plot
	  render.rect(tableCloth.viewport.ctx, this.scale(-100) + xOffset, this.options.y - yOffset, this.scale(100) - this.scale(-100), this.options.height, '#DDDDDD', 0.8);

	  // render the color indicator for the row
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset + 13, this.options.y - yOffset, 24, this.options.height, this.options.cellColor);

	  // render the type text for the row
	  render.text(tableCloth.viewport.ctx, this.options.pertType, this.options.x + xOffset + 16, this.options.y - yOffset + 19, 'white');

	  // render the score text for the row
	  render.text(tableCloth.viewport.ctx, this.options.score.toFixed(2), this.options.width - 60, this.options.y - yOffset + 19);

	  // render the score indicator for the row
	  render.rect(tableCloth.viewport.ctx, this.scale(this.options.score) + xOffset, this.options.y - yOffset, 2, this.options.height, this.options.cellColor);

	  // render an overlay to emphasize the |90 - 100| scores
	  render.rect(tableCloth.viewport.ctx, this.scale(-90) + xOffset, this.options.y - yOffset, this.scale(90) - this.scale(-90), this.options.height, '#DDDDDD', 0.8);
	  ...
	  this.options.subCells.forEach(function (cell) {
	    if (cell.options.score >= 90) {
	      render.rect(tableCloth.viewport.ctx, this.scale(100) + xOffset + posXOffset, this.options.y - yOffset + numPosSig % 4 * squareSize, squareSize, squareSize, cell.options.cellColor);
	    ...
	    if (cell.options.score <= -90) {
	      render.rect(tableCloth.viewport.ctx, this.scale(-100) + xOffset - negXOffset, this.options.y - yOffset + numNegSig % 4 * squareSize, squareSize, squareSize, cell.options.cellColor);
	...
	queryResultViewerBodyCell.prototype.renderHighlight = function (tableCloth, xOffset, yOffset) {
	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, 5, this.options.height, 'black');
	...
	queryResultViewerSummaryCell.prototype.open = function (duration) {
	  ...
	  this.options.cellManager.addCellsAtIndex(cells, this.options.index + 1, duration);
	  this.options.subCells.forEach(function (cell) {
	...
	queryResultViewerSummaryCell.prototype.close = function (duration) {
	  this.options.cellManager.removeCellsAtIndexRange(this.options.index + 1, this.options.index + this.options.subCells.length + 1, duration);
	  return this;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var queryResultViewerBodyCell = __webpack_require__(19);
	var queryResultViewerSummaryCell = __webpack_require__(22);
	var cellOptions = __webpack_require__(25);
	var render = __webpack_require__(15);
	var util = __webpack_require__(3);
	var _ = __webpack_require__(4);
	...
	queryResultViewerHeaderCell.prototype.render = function (tableCloth, xOffset, yOffset, highlight) {
	  ...
	  this.setScale(templateCell.scale.domain(), templateCell.scale.range());

	  // render the background of the cell

	  render.rect(tableCloth.viewport.ctx, this.options.x + xOffset, this.options.y - yOffset, this.options.width, this.options.height, this.options.bgColor);
	  ...
	  // render the cell label
	  render.text(tableCloth.viewport.ctx, this.options.title, this.options.x + xOffset + 40, this.options.y - yOffset + 17);
	  ...
	  render.text(tableCloth.viewport.ctx, this.options.summaryPct.toFixed(2), this.options.width - 60, this.options.y - yOffset + 17);
	  ...
	  for (var bin in this.binnedScores) {
	    ...
	    render.rect(tableCloth.viewport.ctx, bin * this.options.binSize, this.options.y - yOffset, this.options.binSize, this.options.height, this.options.binColor, opacity);
	  }

	  // render an overlay to emphasize the |90 - 100| scores
	  render.rect(tableCloth.viewport.ctx, this.scale(-90) + xOffset, this.options.y - yOffset, this.scale(90) - this.scale(-90), this.options.height, this.options.bgColor, 0.8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basicScrollManager = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basicScrollManager = function (cellManager) {
	  ...
	  this.hammertime.on('panend', function (ev) {
	    ...
	    var maxScroll = self.cellManager.cellsHeight - self.cellManager.tableCloth.options.height + self.cellManager.headerHeight;
...
/***/ function(module, exports, __webpack_require__) {
	...
	basicMouseManager = __webpack_require__(29);
